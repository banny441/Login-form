...
def register():
    ...
    Label(register_screen, text="Please enter your detail below", bg="green").pack()
    ...
    password_entry.pack()
    Label(register_screen, text="").pack()
    Button(register_screen, text="Register", width=12, height=2, bg="blue", command=register_user).pack()
...
def login():
    ...
    Label(login_screen, text="Please enter your details below to login",bg="green").pack()
    ...
    Label(login_screen, text="Username * ",bg="red").pack()
    username_login_entry = Entry(login_screen, textvariable=username_verify)
    username_login_entry.pack()
    Label(login_screen, text="").pack()
    Label(login_screen, text="Password * ",bg="red").pack()
    password_login_entry = Entry(login_screen, textvariable=password_verify, show='*')
    password_login_entry.pack()
    Label(login_screen, text="").pack()
    Button(login_screen, text="Login", width=12, height=2,bg="green", command=login_verify).pack()
...
# Designing popup for login success message
...
# Designing popup for login invalid password message
...
# Designing popup for user not found message
